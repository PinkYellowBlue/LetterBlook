<template>
 <div class="shop_details">
      <div class="shop_info">
        <div class="shop_naph">
          <el-input placeholder="请输入店名" v-model="info.name" clearable hide-required-asterisk=true>
        ...
        <el-input placeholder="请输入商家描述（一句话）" v-model="info.remark" clearable>
          ...
          <el-select v-model="themeid" placeholder="请选择主题" style="margin-bottom:30px" label="请选择主题" clearable>
      ...
      hasInfo(){
        ...
        .then(response=>{
          ...
          if (response.data.result == "0") {
            ...
            this.themeid = response.data.data.merchantInformation.themeId;
